...
# Vendor Blobs
git clone https://github.com/itsHanibee/vendor_xiaomi_chime vendor/xiaomi/chime

# Kernel
git clone --depth=1 https://github.com/itsHanibee/kernel_xiaomi_chime -b main kernel/xiaomi/chime
